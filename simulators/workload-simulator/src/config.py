"""
Configuration settings for Workload Simulator.
"""
...
class Settings(BaseSettings):
    ...
    REDPANDA_PRODUCER_CLIENT_ID: str = Field(default="workload-simulator", validation_alias="REDPANDA_PRODUCER_CLIENT_ID")
    ...
    OTEL_SERVICE_NAME: str = Field(default="workload-simulator", validation_alias="OTEL_SERVICE_NAME")
