"""
Configuration settings for DNS Simulator.
"""
...
class Settings(BaseSettings):
    ...
    PORT: int = Field(default=8083, validation_alias="PORT")
    ...
    REDPANDA_PRODUCER_CLIENT_ID: str = Field(default="dns-simulator", validation_alias="REDPANDA_PRODUCER_CLIENT_ID")
    ...
    OTEL_SERVICE_NAME: str = Field(default="dns-simulator", validation_alias="OTEL_SERVICE_NAME")
